...
/*
 * ok6410_features string
 *
 * 0-9 LCD configuration
 *
 */
static char ok6410_features_str[12] __initdata = "0";

static int __init ok6410_features_setup(char *str)
{
	if (str)
...
__setup("ok6410=", ok6410_features_setup);

#define FEATURE_SCREEN (1 << 0)

struct ok6410_features_t {
	int done;
	int lcd_index;
};

static void ok6410_parse_features(
		struct ok6410_features_t *features,
